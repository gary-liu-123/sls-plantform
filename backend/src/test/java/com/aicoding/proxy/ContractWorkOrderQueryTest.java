...
public class ContractWorkOrderQueryTest {
    ...
    public static void main(String[] args) throws Exception {
        queryContractWorkOrderById(162870171);
    }

    /**
     * 根据ID查询单个合同工单
     */
    public static void queryContractWorkOrderById(long id) throws Exception {
