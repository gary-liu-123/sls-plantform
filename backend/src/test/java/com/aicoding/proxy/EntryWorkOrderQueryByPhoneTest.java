...
public class EntryWorkOrderQueryByPhoneTest {
    ...
    private static final String UNIQUE_FIELD_API_NAME = "personalPhone";

    public static void main(String[] args) throws Exception {
        queryEntryWorkOrderByPhone("15651818750");
    }

    /**
     * 根据个人电话(personalPhone)查询入职工单
     * 通过接口规范 3.3 的"唯一字段+字段值"定位方式
     */
    public static void queryEntryWorkOrderByPhone(String phone) throws Exception {
        ...
        System.out.println("=== 按 personalPhone 查询入职工单 ===");
